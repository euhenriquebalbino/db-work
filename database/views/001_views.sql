...
CREATE OR ALTER VIEW dbo.vw_media_alunos
AS
...
CREATE OR ALTER VIEW dbo.vw_alunos_aprovados
AS
  SELECT *
...
CREATE OR ALTER VIEW dbo.vw_alunos_reprovados
AS
  SELECT *
  FROM dbo.vw_media_alunos
...
CREATE OR ALTER VIEW dbo.vw_notas_por_turma
AS
...
CREATE OR ALTER VIEW dbo.vw_historico_escolar
AS
