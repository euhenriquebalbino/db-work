...
export class ProfessoresController {
  ...
  @Post() create(@Body() dto: CreateProfessorDto) { return this.service.create(dto); }
  ...
  @Patch(':id') update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateProfessorDto) { return this.service.update(id, dto); }
