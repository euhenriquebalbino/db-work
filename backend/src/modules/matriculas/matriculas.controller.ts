...
export class MatriculasController {
  ...
  @Post() create(@Body() dto: CreateMatriculaDto) { return this.service.create(dto); }
  ...
  @Patch(':id') update(@Param('id', ParseIntPipe) id: number, @Body() dto: UpdateMatriculaDto) { return this.service.update(id, dto); }
